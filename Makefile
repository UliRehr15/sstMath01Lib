...
# Template: lib
# Command: /usr/lib/qt5/bin/qmake -o Makefile sstMath01Lib.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I../sst_str01_lib/Header -IHeader -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-clang
...
DISTDIR = /home/uli/Entwicklung/sstMath01Lib/.tmp/sstMath01Lib_d1.0.0
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
../libs/libsstMath01Lib_d.a:  $(OBJECTS) $(OBJCOMP) 
	@test -d ../libs/ || mkdir -p ../libs/
	-$(DEL_FILE) ../libs/$(TARGET)
	$(AR) $(DESTDIR)$(TARGET) $(OBJECTS)


Makefile: sstMath01Lib.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-clang/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		sstMath01Lib.pro
	$(QMAKE) -o Makefile sstMath01Lib.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
...
all: Makefile ../libs/libsstMath01Lib_d.a
